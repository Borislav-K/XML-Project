...
public class XMLToSQLConverterTest {
    ...
    public void testXMLToSQLWithBadlyStructuredXMLFile() throws BadlyStructuredXMLException, InvalidXMLException {
        testConverter.convertXMLToSQL(new StringReader(BADLY_STRUCTURED_XML));
    }

    @Test(expected = InvalidXMLException.class)
    public void testXMLToSQLWithInvalidXMLFile() throws BadlyStructuredXMLException, InvalidXMLException {
        testConverter.convertXMLToSQL(new StringReader(INVALID_XML));
    }

    @Test
    public void testXMLToSQLWithEmptyXMLFile() throws BadlyStructuredXMLException, InvalidXMLException {
    ...
    @Test
    public void testXMLToSQLBaseCase() throws BadlyStructuredXMLException, InvalidXMLException {
